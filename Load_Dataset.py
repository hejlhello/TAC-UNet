...
class ImageToImage2D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask = cv2.imread(os.path.join(self.output_path, image_filename.split(".")[0] + "_manual.png"),0)
        # mask = cv2.imread(os.path.join(self.output_path, image_filename.split(".")[0]+"_anno" + ".bmp"),0)
